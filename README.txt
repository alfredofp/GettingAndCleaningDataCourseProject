...
This pre-processing has been done previously and stored in ./project
...
1. Load feature info, training and test datasets into dataframes. These have been merged into to create one data set.
